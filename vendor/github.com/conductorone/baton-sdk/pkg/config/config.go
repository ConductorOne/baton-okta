...
func DefineConfiguration[T any](
	...
	// AFIOFJEWLIFJFEWOFQWOFUWO*UWFQOIUQFW# fix the return value to be of type T
	return nil, mainCMD, nil
}
...
// type Asdf = cli.GetConnectorFunc

// func DefineConfiguration2[T any](
// 	ctx context.Context,
// 	connectorName string,
// 	connector cli.GetConnectorFunc2[T],
// 	schema field.Configuration,
